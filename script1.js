...
// Create the subject list dynamically
Object.keys(courses).forEach(subject => {
    const subjectItem = document.createElement('li');
    subjectItem.textContent = subject;
    subjectItem.addEventListener('click', () => displayCourseDetails(subject));
    subjectsList.appendChild(subjectItem);
});

// Function to display the course details
function displayCourseDetails(subject) {
